      ...
      <div class="modal-body">
		...
		<div class="page-wrapper">
			...
			<div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-secondary">Our Academy Fees Data</p>
										<h4 class="my-1">05/12/2024</h4> 
									</div>
					...
					<div class="col">
					    <a href="otherAcademy.php">
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-secondary">Other Academy Data</p>
										<h4 class="my-1">31/08/2024</h4>
									</div>
									<div class="widgets-icons bg-light-success text-success ms-auto"><i class="bx bx-building"></i>
									</div>
								</div>
					...
					<div class="col">
					       <a href="https://asset.inforiya.in/ERP/ERP_image/data/Other_Company_Intern details.jpg" target="blank">
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-secondary">Other Academic Details</p>
										<h4 class="my-1">Click to view</h4>	
									</div>
					...
					<div class="col">
					    <a href="https://docs.google.com/document/d/1nozYDmCF2lxjy9m6U4LKmKrNB0dfwCFyr-OItpQHM5c/edit?usp=sharing" target="blank">
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-secondary">Payment Gateway</p>
										<h4 class="my-1">Click To View</h4>
									</div>
					...
					<div class="col">
					    <a href="https://docs.google.com/document/d/1SWIVS-NwckLGdnkO7SpK6TVpj2e5Prv3r5OOkFGBF4A/edit?tab=t.0" target="blank">
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<div>
										<p class="mb-0 text-secondary">Whatsapp Integration</p>
										<h4 class="my-1">Click To View</h4>
									</div>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<a href="#"><div class="text-primary ms-auto font-35"><i class='bx bxs-network-chart'></i></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<a href="#"><div class="text-danger ms-auto font-35"><i class='bx bxs-book'></i></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<a href="#"><div class="text-warning ms-auto font-35"><i class='bx bxs-folder'></i></a>
									</div>
								</div>
							</div>
						</div>
