...
include "db/dbConnection.php";
    ...
    $selQuery = "SELECT
                    ...
                    a.`contact`,
                    a.`url`,
                    b.`name` AS inchargeName
                FROM
                    `official_contact` AS a 
                LEFT JOIN 
                    `basic_details` AS b 
                ON 
                    a.`name` = b.`id`
		...
		<div class="page-wrapper">
			<div class="page-content">
			    <div class="page-title-box">
                    <div class="row">
                        <div class="col">
                            <h2 class="page-title" id="catHeading">Contact Details</h2>
                        </div>
                        <div class="col text-end pb-3">
                            <button type="button" id="addContact" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addContactModal">
							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="col-2 text-center">Incharge Department</th>
								...
								<tbody>
                                    ...
                                    $id         = $row['contact_id']; 
                                    $name       = htmlspecialchars($row['inchargeName'], ENT_QUOTES);
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-2 text-center"><?php echo $department; ?></td>
                                        <td class="col-2 text-center"><a href="tel:<?php echo htmlspecialchars($contact); ?>"><?php echo htmlspecialchars($contact); ?></a></td>
                                        <td class="col-3 text-center"><a href="<?php echo htmlspecialchars($url); ?>" target="_blank"><?php echo htmlspecialchars($url); ?></a></td>
                                        <td class="col-2 text-center">
                                            <button type="button" class="btn btn-sm btn-outline-warning" onclick="goEditContact(<?php echo $id; ?>);" data-bs-toggle="tooltip" title="Edit Contact" data-bs-target="#top"><i class="lni lni-pencil"></i></button>
                                            <button class="btn btn-sm btn-outline-danger" data-bs-toggle="tooltip" title="Delete Contact" data-bs-target="#top" onclick="goDeleteContact(<?php echo $id; ?>);"><i class="lni lni-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php } ?>
								</tbody>
