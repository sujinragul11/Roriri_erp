...
$selQuery = "SELECT * FROM `enquire_tbl` WHERE enquire_status='Active' AND entity_id = 2 ORDER BY enquire_id DESC";
...
<style>
    ...
    <div class="row mb-3">
        ...
        <!-- Table to display the contacts report -->
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							...
							<?php $i = 1; while ($row = mysqli_fetch_assoc($resQuery)): ?>
								<tr>
									...
									<td><?php echo htmlspecialchars($row['e_mobile']); ?></td>
									<td><?php echo htmlspecialchars($row['e_email']); ?></td>
									<td><?php echo htmlspecialchars($row['e_address']); ?></td>
									<td><?php echo htmlspecialchars($row['enquire_details']); ?></td>
								</tr>
							<?php endwhile; ?>
							<?php else: ?>
