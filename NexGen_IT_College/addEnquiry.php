			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmAddEnquiry" id="addEnquiry" enctype="multipart/form-data" novalidate>
			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmEditEnquire" id="editEnquiry" enctype="multipart/form-data" novalidate>
