	...
	<div class="wrapper">
        ...
        <?php   if ($_SESSION['id'] != 86) {?>
          <div class="container-fluid">
                                    ...
                                    $sqlGetCourseId = "SELECT course_id FROM trainee_additional_details WHERE basic_id = '$trainee_id'";
                                    
                                    $resCourse = mysqli_query($conn, $sqlGetCourseId);
                                    if ($resCourse && mysqli_num_rows($resCourse) > 0) {
                                        $rowCourse = mysqli_fetch_assoc($resCourse);
                                        $course_id = $rowCourse['course_id'];
                                                    
                                            $selQuery = "SELECT * FROM `application_tbl` WHERE application_status = 'Active' AND course_id = '$course_id'";
                                            ...
                                            ?>
                                                <tr class="odd <?php echo $rowClass; ?>">
                                                    ...
                                                    <td class="border text-center"><?php echo $application_name; ?></td>
                                                    <td class="border text-center"><?php echo $application_duration; ?></td>
                                                    <td class="border text-wrap"><?php echo $application_discription; ?></td>
                                                    <td class="border text-center"><?php echo ($date_time === "0000-00-00 00:00:00" || empty($date_time)) ? '' : date("d M Y H:i:s", strtotime($date_time)); ?></td>
                                        ...
                                        <td class="border text-center">
                                            ...
                                            ?>
                                                <button type="button" class="btn btn-circle btn-info text-white modalBtn"  
                                                        ...
                                                        <?php echo $rowClass === "trainerTablecomplete" ? 'disabled' : ''; ?>>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 row-cols-xl-4">
					<div class="col">
						<div class="card border-primary border-bottom border-3 border-0">
							<img src="https://asset.inforiya.in/ERP/ERP_image/InternCourse/AWS_.jpeg" class="card-img-top object-fit-cover" alt="...">
							<div class="card-body">
								<h5 class="card-title text-primary">Create the Scientific Calculator</h5>
								<p class="card-text">Develop a responsive scientific calculator with advanced functions, including trigonometry, logarithms, and power operations.</p>
								<hr>
								<div class="d-flex align-items-center gap-2">
									<a href="javascript:;" class="btn btn-inverse-primary"><i class='bx bx-star'></i>View</a>
									<a href="javascript:;" class="btn btn-primary"><i class='bx bx-microphone' ></i>Edit</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card border-danger border-bottom border-3 border-0">
							<img src="https://asset.inforiya.in/ERP/ERP_image/InternCourse/Python_.webp" class="card-img-top object-fit-cover" alt="...">
							<div class="card-body">
								<h5 class="card-title text-danger">Drag and Drop</h5>
								<p class="card-text">This task involves moving items or elements from one location to another by clicking, dragging, and releasing them in the desired area.</p>
								<hr>
								<div class="d-flex align-items-center gap-2">
									<a href="javascript:;" class="btn btn-inverse-danger"><i class='bx bx-star'></i>View</a>
									<a href="javascript:;" class="btn btn-danger"><i class='bx bx-microphone' ></i>Edit</a> 
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card border-success border-bottom border-3 border-0">
							<img src="https://asset.inforiya.in/ERP/ERP_image/InternCourse/JavaScript Intern_.jpg" class="card-img-top object-fit-cover" alt="...">
							<div class="card-body">
								<h5 class="card-title text-success">Save Multiple Images</h5>
								<p class="card-text">To save multiple images, you can implement a loop or multi-select functionality that uploads and processes each image one by one.</p>
								<hr>
								<div class="d-flex align-items-center gap-2">
									<a href="javascript:;" class="btn btn-inverse-success"><i class='bx bx-star'></i>View</a>
									<a href="javascript:;" class="btn btn-success"><i class='bx bx-microphone' ></i>Edit</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="card border-warning border-bottom border-3 border-0">
							<img src="https://asset.inforiya.in/ERP/ERP_image/InternCourse/Mobile App Developer_.png" class="card-img-top object-fit-cover" alt="...">
							<div class="card-body">
								<h5 class="card-title text-warning">Search Filter</h5>
								<p class="card-text">Enhance user experience with a streamlined search filter that allows quick access to relevant content, improving navigation and reducing search time.</p>
								<hr>
								<div class="d-flex align-items-center gap-2">
									<a href="javascript:;" class="btn btn-inverse-warning"><i class='bx bx-star'></i>View</a>
									<a href="javascript:;" class="btn btn-warning"><i class='bx bx-microphone' ></i>Edit</a>
								</div>
							</div>
						</div>
					</div>
