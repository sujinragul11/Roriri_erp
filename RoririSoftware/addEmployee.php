			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmAddEmployee" id="addEmployee" enctype="multipart/form-data" novalidate>
			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmAddSalary" id="addSalary" novalidate>
...
<div class="modal fade" id="addWorkModal" tabindex="-1" aria-labelledby="addEmployeeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="employeeModalLabel">Add Work Details</h5>
                <button type="button" class="btn-close" id="modalCloseBtn" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="card-body p-4">
              <form class="row g-3 needs-validation" name="frmAddWork" id="addWork" novalidate>
                <input type="hidden" name="hdnAction" value="addWork">
                <input type="hidden" name="coordinatorId" value="<?php echo $empId; ?>">
                ...
                <div class="col-md-12">
                    <div class="mb-4">
                        ...
                        <select class="form-select" name="deptId" id="deptId" required>
                            ...
                            <?php
                            // Existing query and data fetching code
             ...
             <?php
                ...
                <div class="col-md-12">
                <label for="workDescription" class="form-label">Work Description <span class="text-danger">*</span></label>
                <div id="quillEditor" style="height: 150px;"></div>
                <textarea name="workDescription" id="workDescription" style="display: none;" required></textarea>
                <div class="invalid-feedback">Please enter a description of the work.</div>
            </div>
            
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" id="submitBtnWork" class="btn btn-primary">Save changes</button>
                </div>
            </form>
            </div>
