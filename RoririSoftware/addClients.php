						...
						<div class="card-body p-4">
								...
								<input type="hidden" name="hdnAction" value="addClient">
									...
									<div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" id="gst" name="gst" placeholder="GST" data-rule="gst" >
                                    ...
                                    <div class="col-md-6">
										<label for="referredBy" class="form-label">Referred By Client <span class="text-muted">(optional)</span></label>
										<select class="form-control" id="referredBy" name="referredBy">
											<option value="">-- None --</option>
											<?php
												$refQ = mysqli_query($conn, "SELECT client_id, client_name, client_company FROM client_tbl WHERE client_status='Active' ORDER BY client_name");
												while ($refRow = mysqli_fetch_assoc($refQ)) {
													echo '<option value="'.$refRow['client_id'].'">'.htmlspecialchars($refRow['client_name'].' ('.$refRow['client_company'].')').'</option>';
												}
											?>
										</select>
									</div>
                                    <div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" name="Username" id="Username" placeholder="Client Login Username" required>
                                    ...
                                    <div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" name="Password" id="Password" placeholder="Client Login Password" required>
			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmAddClient" id="editClient" enctype="multipart/form-data" novalidate>
                                ...
                                <input type="hidden" name="editIdClient" id="editIdClient" value="">
									...
									<div class="col-md-6">
										...
										<div class="position-relative input-icon">
											<input type="text" class="form-control" id="gstE" name="gstE" placeholder="GST" required data-rule="gst">
											<span class="position-absolute top-50 translate-middle-y"><i class='bx bx-envelope'></i></span>
										</div>
									</div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<label for="UsernameE" class="form-label">Username <span class="text-danger">*</span></label>
										<input type="text" class="form-control" name="UsernameE" id="UsernameE" placeholder="Client Login Username" required>
										<div id="usernameErrorE" class="error-message">Username is required.</div>
									</div>
                                    <div class="col-md-6">
										<label for="PasswordE" class="form-label">Password <span class="text-danger">*</span></label>
										<input type="text" class="form-control" name="PasswordE" id="PasswordE" placeholder="Client Login Password" required>
										<div id="passwordErrorE" class="error-message">Password is required.</div>
									</div>
