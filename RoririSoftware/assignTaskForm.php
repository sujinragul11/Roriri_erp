		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="clientModalLabel">Assign Task</h5>
...
<div class="col-md-6">
    ...
    <select class="form-select" id="employee" name="employee[]" data-placeholder="Choose Employee" required multiple>
        <option value="select_all">Select All</option> <!-- Add Select All option -->
        <?php
...
<div class="modal fade" id="editReportModal" tabindex="-1" aria-labelledby="editReportModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >Edit Asisign Task ( <span id="setName"></span> )</h5>
            ...
            <div class="card-body p-4">
                <form class="row g-3 needs-validation" name="frmAddDepartment" id="editDepartment" enctype="multipart/form-data" novalidate>
                    ...
                    <input type="hidden" name="nameEdit" id="nameEdit">
                     ...
                     <div class="col-md-6">
    <label for="workingDate" class="form-label">Assigned Date<span class="text-danger">*</span></label>
    <input type="date" class="form-control" id="assignDate" name="workingDate" value="<?= date('Y-m-d') ?>" required>
    ...
    <div class="col-md-12">
        <label for="hoursEdit" class="form-label">Assigned Hours <span class="text-danger">*</span></label>
        <input type="number" class="form-control" name="hoursEdit" id="hoursEdit" min="0" step="any" placeholder="Enter number of hours spent" required>
