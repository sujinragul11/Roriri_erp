...
include("../url.php");    
   $empId = isset($_GET['empid']) ? (int)$_GET['empid'] : 0;
...
<style>
		...
		<div class="page-wrapper">
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    ...
                    <button type="button" id="addEmployeeBtn" class="btn btn-primary position-absolute top-0 end-0" data-bs-toggle="modal" data-bs-target="#addEmployeeModal"><i class="lni lni-plus"></i>New Employee</button>
                    </div>
					...
					<div class="card-body">
						<div class="table-responsive">
                            ...
                            <div class="mb-3 col-sm-2">
                                ...
                                <select id="statusFilter" class="form-select bg-success text-white" onchange="filterStatus()">
                                    <option value="Active" class="bg-success text-white" selected>Active</option>
                                    <option value="Inactive" class="bg-danger text-white">Inactive</option>
                                </select>
                            </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const dobInput = document.getElementById("jDate");
        
        const today = new Date().toISOString().split("T")[0]; // Get today's date in YYYY-MM-DD format
        dobInput.setAttribute("max", today);
        
        
         const dobInputEdit = document.getElementById("editjDate");
        const todayEdit = new Date().toISOString().split("T")[0]; // Get today's date in YYYY-MM-DD format
        dobInputEdit.setAttribute("max", dobInputEdit);
    });
    
    
  document.addEventListener("DOMContentLoaded", function () {
        const dobInput = document.getElementById("dob");
        const dobInputEdit = document.getElementById("editDob");
        ...
        // Set the min attribute to ensure user is at least 18 years old
        dobInput.setAttribute("max", minDate);
        dobInputEdit.setAttribute("max", minDate);
    });
...
function filterStatus() {
    ...
    if (filter === 'Active') {
        statusFilter.classList.add('bg-success');  // Green for Active
        statusFilter.classList.remove('bg-danger');              // Remove red background
    } else if (filter === 'Inactive') {
        statusFilter.classList.add('bg-danger');   // Red for Inactive
        statusFilter.classList.remove('bg-success');             // Remove green background
    }
