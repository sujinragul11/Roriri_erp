		...
		<div class="page-wrapper">
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <h2 class="page-title">Client Enquiry</h2>
						...
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
                                ...
                                <?php $i=1; while($row = mysqli_fetch_array($resQuery , MYSQLI_ASSOC)) { 
                                        ...
                                        $date        = ($row['e_date'] === '0000-00-00' || empty($row['e_date'])) ? '-' : date("d M Y", strtotime($row['e_date']));
  ...
  
  {
    $.ajax({
        ...
        success: function(response) {
          ...
          $('#estatusEdit').val(response.estatus);
...
$('#submitBtn').click(function (e) {
    ...
    // Validate fields
         ...
         isValid &= validateField('estatus', 'statusError');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#updateBtn').click(function (e) {
        ...
        isValid &= validateField('dateEdit', 'dateErrorE');
        isValid &= validateField('estatusEdit', 'statusErrorE');
        if (isValid) {
