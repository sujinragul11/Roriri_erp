...
<style>
	...
	<div class="wrapper">
        ...
        <?php include("dailyReportForm.php");?>
...
$(document).ready(function() {
  ...
  var reportTable = $('#example3').DataTable({
    ...
    "columns": [
        { data: "sid", orderable: true, className: "col-1", render: truncateRender },
        { data: "desription", visible: false },
        { data: "image", visible: false },
        { data: "url", visible: false },
        { data: "date", orderable: true, className: "col-1", render: truncateRender }, // 0
        { data: "working_date", orderable: true, className: "col-1", render: truncateRender }, // 1
        { data: "name", visible: isAdminOrSuperAdmin, orderable: true, className: "col-1", render: truncateRender }, // 2
        { data: "created_by", orderable: true, className: "col-1", render: truncateRender }, // 7
        { data: "category", orderable: true, className: "col-1", render: truncateRender }, // 3
        { data: "subcategory", orderable: true, className: "col-1", render: truncateRender }, // 4
        { data: "task", orderable: true, className: "col-1", render: truncateRender }, // 5
        { data: "hours", orderable: true, className: "col-1", render: truncateRender }, // 6
        { data: "working_hours", orderable: true, className: "col-1", render: truncateRender }, // 7
        { data: "task_status", orderable: true, className: "col-1", render: truncateRender }, // 8
        { data: "action", className: "col-1"} // 9
    ],
...
// General render function for truncation and tooltip
function truncateRender(data, type, row) {
    if (type === 'display' && data) {
        return `
            <div class="text-truncate" style="max-width: 200px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" 
                data-bs-toggle="tooltip" data-bs-placement="top" title="${data}">
                ${data}
            </div>
        `;
    }
