                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <div class="position-relative" style="height: 80px;">
                            ...
                            <button type="button" id="addProjectBtn" class="btn btn-primary position-absolute top-0 end-0" data-bs-toggle="modal" data-bs-target="#addProjectModal"><i class="lni lni-plus"></i>Project</button>
                        </div>
                    </div>
                </div>
                <div class="card">
