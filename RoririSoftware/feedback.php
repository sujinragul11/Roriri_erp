		...
		<!--sidebar wrapper -->
			<?php  
                ...
                if ($_SESSION['is_admin'] == 'True') {
                    ...
                    include "../NexGen_IT_Academy/left.php";
                }
            ?>
		<!--end sidebar wrapper -->
		<!--start header -->
...
function addCoordinator(id, name) {
    ...
    if (response.success) {
        ...
        // Initialize an empty array for active coordinator IDs
        ...
        if (coordinators) {
            ...
            if (Array.isArray(coordinators)) {
                // Filter IDs with status 'active'
                activeCoordinatorIds = coordinators
                    .filter(coordinator => coordinator.status === 'active') // Filter active coordinators
                    .map(coordinator => coordinator.id); // Extract IDs
        ...
        // Set the values in the multi-select field
