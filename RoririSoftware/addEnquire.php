			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmAddEnquire" id="addEnquire" enctype="multipart/form-data" novalidate>
								<input type="hidden" name="hdnAction" value="addEnquire">
									...
									<div class="col-md-6">
										<label for="date" class="form-label">Enquiry Date</label>
										<div class="position-relative input-icon">
											<input type="date" class="form-control" id="date" name="date" placeholder="Date" required max="<?= date('Y-m-d') ?>" value="<?= date('Y-m-d') ?>">
											<span class="position-absolute top-50 translate-middle-y"><i class='bx bx-calendar'></i></span>
										</div>
										<div id="dateError" class="error-message">Enquiry Date is required.</div>
									</div>
									
									<div class="col-md-6">
										<label for="estatus" class="form-label">Enquiry Status<span class="text-danger">*</span></label>
										<div class="position-relative input-icon">
											<select class="form-control" name="estatus" id="estatus" required>
                                                <option value="">--Select Status--</option>
                                                <option value="In Progress">In Progress</option>
                                                <option value="Project Confirmed">Project Confirmed</option>
                                                <option value="Waiting for Quotation">Waiting for Quotation</option>
                                                <option value="Cancelled">Cancelled</option>
                                            </select>
											<span class="position-absolute top-50 translate-middle-y"><i class='bx bx-list-check'></i></span>
										</div>
										<div id="statusError" class="error-message">Enquiry Status is required.</div>
									</div>
			...
			<div class="modal-content">
					<div class="modal-header">
						...
						<div class="card-body p-4">
								...
								<form class="row g-3 needs-validation" name="frmEditEnquire" id="editEnquire" enctype="multipart/form-data" novalidate>
                                ...
                                <input type="hidden" name="editIdEnquire" id="editIdEnquire" value="">
									...
									<div class="col-md-6">
										<label for="dateEdit" class="form-label">Enquiry Date</label>
										<div class="position-relative input-icon">
											<input type="date" class="form-control" id="dateEdit" name="dateEdit" placeholder="Date" required max="<?= date('Y-m-d') ?>">
											<span class="position-absolute top-50 translate-middle-y"><i class='bx bx-calendar'></i></span>
										</div>
										<div id="dateErrorE" class="error-message">Enquiry Date is required.</div>
									</div>
									
									<div class="col-md-6">
										<label for="estatusEdit" class="form-label">Enquiry Status<span class="text-danger">*</span></label>
										<div class="position-relative input-icon">
											<select class="form-control" name="estatusEdit" id="estatusEdit" required>
                                                <option value="">--Select Status--</option>
                                                <option value="In Progress">In Progress</option>
                                                <option value="Project Confirmed">Project Confirmed</option>
                                                <option value="Waiting for Quotation">Waiting for Quotation</option>
										...
										<div id="statusErrorE" class="error-message">Enquiry Status is required.</div>
									</div>
