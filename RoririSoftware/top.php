        ...
        ?>
					...
					<div class="user-box dropdown px-3">
						...
						<ul class="dropdown-menu dropdown-menu-end">
						    <?php
                                  $trainerRoles = [1,2,3,4,5,6,7,8,9,12,13,14,15,16]; // Define the Admin of roles
                                  if (in_array($_SESSION['role'], $trainerRoles)) 
                                  {
                            ?>
							<li><a class="dropdown-item d-flex align-items-center" href="../RoririSoftware/employeeDetails.php?id=<?php echo $_SESSION['id']; ?>"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
							</li>
							<?php
                            }
                            ?>
