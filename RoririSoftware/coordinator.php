		...
		<div class="page-wrapper">
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <h2 class="page-title">Coordinators List</h2>
                </div>
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <h2 class="page-title" id="hisHeading">Coordinators History</h2>
			...
			<div class="page-content" id = "reporttbl" style="display:none;">
                
				
            <div class="page-title-box">
                
                <div class="page-title-right">
                    <h2 class="page-title">Coordinator Report</h2>
                    <div class="position-relative" style="height: 80px;"> <!-- Adjust height as needed -->
                     <button type="button" id="backReportBtn" class="btn btn-danger position-absolute top-0 end-0">Back</button> 
                    </div>
                </div>
							...
							<table id="example4" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="col-8 text-wrap">Work Details</th>
									</tr>
								</thead>
								<tbody>
...
function decodeHtmlEntities(encodedString) {
    ...
    tempDiv.innerHTML = encodedString; // Set the HTML content
    return tempDiv.innerHTML; // Return the decoded HTML
}
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#hisHeading').text(historyData[0].name + ' Coordinators History');
                    ...
                    historyData.forEach(function(row) {
                        ...
                        log.forEach(function(entry) {
                            ...
                            historyTable.row.add([
                                ...
                                changeTime ? formatDate(changeTime) : 'Present',
                                totalDays,
                                `<button class="btn btn-success btn-sm" onclick="viewReport(${row.id}, ${entry.id});">Report</button>`
    ...
    $(document).on('click', '#backReportBtn', function() {
        $('#reporttbl').hide();
        $('#histroytbl').show();
    });
});

function viewReport(id,coorId){
    const reportTable = $('#example4').DataTable();
