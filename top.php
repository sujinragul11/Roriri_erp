					...
					<div class="user-box dropdown px-3">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li class="dropdown-item d-flex align-items-center" 
                                onclick="goEditPassword(<?php echo $admin_id; ?>);" 
							...
							<li><a class="dropdown-item d-flex align-items-center" href="RoririSoftware/logout.php"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
