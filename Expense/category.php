		...
		<div class="page-wrapper">
            ...
            <div class="page-title-box">
                <div class="page-title-right pb-3">
                    <h2 class="page-title text-muted text-decoration-underline">Categories</h2>
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" id="addCategoryBtn" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#addCategoryModal">
                            <i class="fadeIn animated bx bx-bookmark-plus"></i>Add Category
                        </button>
                    </div>
                </div>
							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="col-9 text-center">Category</th>
								...
								<tbody>
                                    ...
                                    $id             = $row['cat_id'];  
                                    $category_name  = htmlspecialchars($row['name'], ENT_QUOTES);
                                    ?>
                                    <tr>
                                        <td class="col-1 text-center"><?php echo $i; $i++; ?></td>
                                        <td class="col-9 text-center"><?php echo $category_name; ?></td>
                                        <td class="col-2 text-center">
                                            <button type="button" class="btn btn-sm btn-outline-warning" onclick="goEditCategory(<?php echo $id; ?>, '<?php echo $category_name; ?>');" data-bs-toggle="tooltip" title="Edit Category" data-bs-target="#top"><i class="lni lni-pencil"></i></button>
                                            <button class="btn btn-sm btn-outline-danger" data-bs-toggle="tooltip" title="Delete Category" data-bs-target="#top" onclick="goDeleteCategory(<?php echo $id; ?>);"><i class="lni lni-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php } ?>   
								</tbody>
...
<div id="loader" style="display: none;">
    ...
    <script>
        ...
        function goDeleteCategory(catId) {
            Swal.fire({
                title: 'Are you sure?',
        ...
        function goEditCategory(catId, catName) {
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'An error occurred while adding Category details.'
                        });
                        $('#submitFormBtn').prop('disabled', false);
                    }
                });
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'An error occurred while updating Category details.'
                        });
                        $('#submitEditBtn').prop('disabled', false);
                    }
                });
